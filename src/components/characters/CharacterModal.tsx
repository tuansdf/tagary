  ...
  return (
    <Dialog open={open} onOpenChange={(isOpen) => !isOpen && onClose()}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>
            {isEditing ? "Sửa nhân vật" : "Thêm nhân vật mới"}
          </DialogTitle>
          <DialogDescription>
            {isEditing
              ? "Cập nhật thông tin nhân vật"
              : "Thêm người mới vào nhật ký của bạn"}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="char-name">Tên *</Label>
            <Input
              id="char-name"
          ...
          {/* Nickname */}
          <div className="space-y-2">
            <Label htmlFor="char-nickname">Biệt danh</Label>
            <Input
              id="char-nickname"
